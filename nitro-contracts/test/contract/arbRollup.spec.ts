...
import { ContractTransaction } from '@ethersproject/nitro-contracts'
...
} from '@offchainlabs/upgrade-executor/build/nitro-contracts/src/UpgradeExecutor.sol/UpgradeExecutor.json'
...
describe('ArbRollup', () => {
  ...
  it('should pause the nitro-contracts then resume', async function () {
